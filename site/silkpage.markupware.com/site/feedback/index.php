...
<title>Feedback -- Let us know what you think about our website.</title>
<meta name="description" content="Let us know what you think about our website." />
<meta name="keywords" content="Feedback, Site" />
</head>
<body class="feedback">
<div id="wrapper">
<div id="header">
...
<div id="menu">
<ul>
<li class="about"><a href="../../about/index.html" title="About SilkPage goals and principles"><span>About</span></a></li>
...
<p>Thank you for taking the time to provide SilkPage with your feedback. We value your feedback and try to evaluate it as soon as we can.</p>
</div>
<?php if ((@$_GET["komail"]==1) OR (@$_GET["notext"]==1) OR (@$_GET["ko"]==1)) {
  ...
  ?>
<form action="/about/feedback-send.php" method="post" id="contactForm">
<fieldset><legend>Feedback Form</legend>
<p class="name"><label for="contactForm-name" accesskey="9">Name:</label><br />
...
<p class="url"><label for="contactForm-url">URL of specific page(s) (if applicable)</label><br />
<textarea name="url" id="contactForm-url" rows="3" cols="50" tabindex="3">
</textarea></p>
<p class="comment"><label for="contactForm-comment">Comments:</label> <em>*</em><br />
<textarea name="comment" id="contactForm-comment" rows="10" cols="50" tabindex="4">
</textarea></p>
...
<hr class="access" />
<div id="footer">
<div id="footitems"><span class="footitem"><a title="Home" href="../../index.html">Home</a></span> <span class="footitem feedback">| <a title="Feedback" href="http://silkpage.markupware.com/site/feedback/">Feedback</a></span></div>
<div class="right">
<div class="sources">Sources<span>:</span> <span class="rdf"><a href="../../site/feedback/index.php.rdf.xml" title="RDF - Feedback">RDF</a> |</span> <span class="xml"><a href="../../about/feedback.xml" title="XML - Feedback">XML</a></span></div>
...
<div class="updated"><span>Last Updated: 2006-04-17T 18:43</span></div>
</div>
</div>
</div>
</body>
